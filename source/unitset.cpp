...
void loadUnitSets(void) {
   ...
   while (!n.empty()) {
      ...
      //      ItemFiltrationSystem::ItemFilter* itf = new ItemFiltrationSystem::ItemFilter (
      //      set->name, set->ids, !set->active ); ItemFiltrationSystem::itemFilters.push_back ( itf
      //      );
...
bool vehicleComp(const VehicleType* v1, const VehicleType* v2) {
   ...
   return (id1 < id2) || (id1 == id2 && v1->movemalustyp < v2->movemalustyp) ||
