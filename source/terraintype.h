  ...
  public:
   ...
   class Weather : public LoadableItemType {
     ...
     public:
      ...
      //! the defense bonus for the unit standing on this field. \see
      //! AttackFormula::defense_defensebonus(int)
      int defensebonus;

      //! the attack bonus for the unit standing on this field. \see
      ...
      //! the image index from the graphic set. -1 if graphics is not from graphic set. \see
      //! GraphicSet
      int bi_pict;
