// Generated by Bisonc++ V2.4.2 on Sat Jul 26 23:16:51 2008 +0100
...
PI__ const s_productionInfo[] = {
   ...
   {261, 2},  // 3: blocks ->  blocks block
   {262, 1},  // 4: block ->  testblock
   {263, 5},  // 5: testblock ->  TESTCASE '{' commands '}' TESTCASE
   {264, 2},  // 6: commands ->  command ';'
   {264, 2},  // 7: commands ->  commands command
   {265, 1},  // 8: command ->  MOVEUNIT
   {265, 1},  // 9: command ->  loadmapcommand
   {266, 4},  // 10: loadmapcommand ->  LOADMAP '(' filename ')'
   {267, 0},  // 11: filename ->  <empty>
   {268, 1},  // 12: asctextfile_$ ->  asctextfile
};

// State info and SR__ transitions for each state.

SR__ const s_0[] = {
   {{REQ_TOKEN}, {6}}, {{260}, {1}},  // asctextfile
   {{261}, {2}},                      // blocks
   {{262}, {3}},                      // block
   {{263}, {4}},                      // testblock
   {{259}, {5}},                      // TESTCASE
...
SR__ const s_7[] = {
   {{REQ_TOKEN}, {6}}, {{264}, {8}},  // commands
   {{265}, {9}},                      // command
   {{257}, {10}},                     // MOVEUNIT
   {{266}, {11}},                     // loadmapcommand
   {{258}, {12}},                     // LOADMAP
   {{0}, {0}},
};
...
SMapVal s_symArr[] = {
   ...
   SMapVal(-1, "_EOF_"),           SMapVal(256, "_error_"),

   SMapVal(257, "MOVEUNIT"),       SMapVal(258, "LOADMAP"),  SMapVal(259, "TESTCASE"),
   SMapVal(260, "asctextfile"),    SMapVal(261, "blocks"),   SMapVal(262, "block"),
   SMapVal(263, "testblock"),      SMapVal(264, "commands"), SMapVal(265, "command"),
   SMapVal(266, "loadmapcommand"), SMapVal(267, "filename"), SMapVal(268, "asctextfile_$"),
};
...
int Parser::lookup(bool recovery) {
   ...
   if (d_debug__) {
      ...
      if (action < 0)  // a reduction is found
         ...
         s_out__ << "): shift " << action << " (" << symbol(d_token__) << " processed)";
