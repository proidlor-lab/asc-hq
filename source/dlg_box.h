...
class tdlgengine {
  ...
  public:
   ...
   void addbutton(const char* ltxt, int lx1, int ly1, int lx2, int ly2, int lart, int lstyle,
                  int lid, bool enabled);
   ...
   void addscrollbar(int lx1, int ly1, int lx2, int ly2, int* numberofitems, int itemsvisible,
                     int* actitem, int lid,
                     int keys); /*   0 = keine tasten-, 1 = immer tasten-, 2= markiert tasten  */
   /*   !! a scrollbar needs the two ids following lid for internal usage !!   */
   void addscrollbar(tmouserect rec, int* numberofitems, int itemsvisible, int* actitem, int lid,
                     int keys);

   void addDropDown(int x1, int y1, int x2, int y2, int ID, const char** entries, int entrynum,
                    int* pos);
...
class tdialogbox : public tdlgengine {
  ...
  public:
   ...
   virtual void
   redrawall(void);  // l��t die aktuelle und alle darunterliegenden Boxen sich neu zeichnen
   virtual void redrawall2(
      int xx1, int yy1, int xx2,
      int yy2);  // l��t die aktuelle und bei Bedarf alle darunterliegenden Boxen sich neu zeichnen
...
extern int viewtextquery(int id, const char* title, const char* s1, const char* s2);
 ...
 */
extern pair<int, int> chooseString(const ASCString& title, const vector<ASCString>& entries,
