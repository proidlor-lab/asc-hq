...
EmailSetupWidget::EmailSetupWidget(GameMap* gamemap, int editablePlayers, PG_Widget* parent,
   ...
   for (int i = 0; i < actmap->getPlayerCount(); ++i)
      if (actmap->player[i].exist()) {
         ...
         ColoredBar* colbar = new ColoredBar(actmap->player[i].getColor(), this,
                                             PG_Rect(colBarXStart, y, Width() - 60, 30));
