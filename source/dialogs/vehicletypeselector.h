...
class VehicleTypeBaseWidget : public SelectionWidget {
  ...
  public:
   VehicleTypeBaseWidget(PG_Widget* parent, const PG_Point& pos, int width,
...
class VehicleBaseWidget : public SelectionWidget {
  ...
  public:
   VehicleBaseWidget(PG_Widget* parent, const PG_Point& pos, int width, const Vehicle* vehicle,
                     const Player& player);
   ASCString getName() const;
...
class VehicleTypeResourceWidget : public VehicleTypeBaseWidget {
  public:
   VehicleTypeResourceWidget(PG_Widget* parent, const PG_Point& pos, int width,
                             const VehicleType* vehicletype, int lackingResources,
                             const Resources& cost, const Player& player);
};

class VehicleTypeCountWidget : public VehicleTypeBaseWidget {
  public:
   VehicleTypeCountWidget(PG_Widget* parent, const PG_Point& pos, int width,
                          const VehicleType* vehicletype, const Player& player, int number);
};
...
class VehicleTypeCountLocateWidget : public VehicleTypeCountWidget {
  ...
  public:
   VehicleTypeCountLocateWidget(PG_Widget* parent, const PG_Point& pos, int width,
                                const VehicleType* vehicletype, const Player& player, int number);
