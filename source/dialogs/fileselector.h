...
class FileInfo {
  public:
   ...
   int level;
   FileInfo(const ASCString& filename, const ASCString& filelocation, time_t time,
            int directorylevel)
      : name(filename), location(filelocation), modificationTime(time), level(directorylevel) {}
...
class FileSelectionWindow : public ASC_PG_Dialog {
  ...
  public:
   ...
   FileSelectionWindow(PG_Widget* parent, const PG_Rect& r, const ASCString& fileWildcard,
                       bool save, bool overwriteMessage);
...
class SavegameSelectionWindow : public ASC_PG_Dialog {
  ...
  public:
   /*! \param wildcard may be several wildcards concatenated by ';' */
   SavegameSelectionWindow(PG_Widget* parent, const PG_Rect& r, const ASCString& fileWildcard,
                           bool save, bool overwriteMessage);
   ASCString getFilename() { return filename; };
};
