...
MessageDialog::MessageDialog(PG_Widget* parent, const PG_Rect& r, const std::string& windowtitle,
                             const std::string& windowtext, const std::string& btn1text,
                             const std::string& btn2text, PG_Label::TextAlign textalign,
                             const std::string& style, bool rememberCheckbox)
   : ASC_PG_Dialog(parent, r, windowtitle, MODAL, style),
     defaultKeysActive(true),
     my_btnok(NULL),
     my_btncancel(NULL) {
   ...
   if (rememberCheckbox)
      checkbox = new PG_CheckButton(this, PG_Rect(10, r.Height() - 65, r.Width() - 20, 20),
                                    bttncount == 2 ? "Remember choice" : "don't show again");
   else
      checkbox = NULL;
...
MessageDialog::MessageDialog(PG_Widget* parent, const PG_Rect& r, const std::string& windowtitle,
                             const std::string& windowtext, const std::string& btn1text,
                             PG_Label::TextAlign textalign, const std::string& style)
   : ASC_PG_Dialog(parent, r, windowtitle, MODAL, style),
     defaultKeysActive(true),
     my_btnok(NULL),
     my_btncancel(NULL),
...
MessageDialog::MessageDialog(PG_Widget* parent, const PG_Rect& r, const std::string& windowtitle,
                             const std::string& windowtext, PG_Label::TextAlign textalign,
...
void MessageDialog::Init(const std::string& windowtext, int textalign, const std::string& style) {
   ...
   my_textbox =
      new TextRenderer(this, PG_Rect(10, 40, my_width - 20, my_height - 50 - heightDelta));
...
int new_choice_dlg(const ASCString& title, const ASCString& leftButton,
...
int new_choice_dlg(const ASCString& title, const ASCString& shortTitle, const ASCString& leftButton,
                   const ASCString& rightButton, bool& saveResult) {
   PG_Rect size = calcMessageBoxSize(title);
