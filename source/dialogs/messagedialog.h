...
class MessageDialog : public ASC_PG_Dialog {
  ...
  public:
    ...
    */
   MessageDialog(PG_Widget* parent, const PG_Rect& r, const std::string& windowtitle,
                 const std::string& windowtext, const std::string& btn1text,
                 const std::string& btn2text, PG_Label::TextAlign textalign = PG_Label::CENTER,
                 const std::string& style = "MessageBox", bool rememberCheckbox = false);
    ...
    */
   MessageDialog(PG_Widget* parent, const PG_Rect& r, const std::string& windowtitle,
                 const std::string& windowtext, PG_Label::TextAlign textalign = PG_Label::CENTER,
                 const std::string& style = "MessageBox");
...
extern int new_choice_dlg(const ASCString& title, const ASCString& leftButton,
                          const ASCString& rightButton);
extern int new_choice_dlg(const ASCString& title, const ASCString& shortTitle,
                          const ASCString& leftButton, const ASCString& rightButton,
                          bool& saveResult);
