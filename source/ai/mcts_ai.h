...
class MCTS_AI : public BaseAI {
  public:
    ...
    */
   MCTS_AI(GameMap* gameMap, int playerID, const Profile& profile,
    ...
    */
   static MCTS_AI* createFast(GameMap* gameMap, int playerID, const AIFactory::AIConfig& config);
    ...
    */
   static MCTS_AI* createDeep(GameMap* gameMap, int playerID, const AIFactory::AIConfig& config);
  ...
  private:
    ...
    */
   bool processUnit(class Vehicle* unit, asc::mcts::ILegacyGameInterface* legacyInterface,
