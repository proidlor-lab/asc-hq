...
public:
    ...
    std::vector<const Vehicle*> getUnitsInRange(
    ...
    std::unique_ptr<GameStateSnapshot> createFullSnapshot(
        PlayerID perspective
    ) const override;
    
    std::unique_ptr<GameStateSnapshot> createTacticalSnapshot(
