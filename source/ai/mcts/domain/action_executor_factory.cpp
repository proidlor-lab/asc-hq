...
std::unique_ptr<IActionExecutor>
ActionExecutorFactory::createSimulationExecutor(std::unique_ptr<IGameState> snapshot,
                                                GameMap* legacyMap) {
...
std::unique_ptr<IActionExecutor> ActionExecutorFactory::createRealGameExecutor(GameMap* gameMap) {
