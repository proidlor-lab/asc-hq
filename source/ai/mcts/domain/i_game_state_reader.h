...
public:
     ...
     */
    virtual std::vector<const Vehicle*> getUnitsInRange(
     ...
     */
    virtual std::unique_ptr<GameStateSnapshot> createFullSnapshot(
     ...
     * @return Unique pointer to snapshot (caller owns)
     */
    virtual std::unique_ptr<GameStateSnapshot> createTacticalSnapshot(
