...
bool MovementAbility::isAvailable(const IGameState& state, const UnitSnapshot& unit) const {
...
std::vector<Action> MovementAbility::generateActions(const IGameState& state,
...
std::vector<MoveAction> MovementAbility::generateReachableMoves(const IGameState& state,
                                                                const UnitSnapshot& unit) const {
...
std::vector<MoveAction> MovementAbility::generateAdjacentMoves(const IGameState& state,
                                                               const UnitSnapshot& unit) const {
...
std::vector<MapCoordinate> MovementAbility::getAdjacentHexes(MapCoordinate center) const {
