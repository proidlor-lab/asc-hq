...
void AbilityRegistry::registerAbility(
    std::string name, 
...
std::vector<IAbility*> AbilityRegistry::getAbilitiesForUnitType(
...
std::vector<IAbility*> AbilityRegistry::getAbilitiesByCategory(
...
std::vector<Action> AbilityActionGenerator::generateAllActions(
    ...
    for (auto* ability : abilities) {
        ...
        allActions.insert(
            allActions.end(),
            std::make_move_iterator(abilityActions.begin()),
...
std::vector<Action> AbilityActionGenerator::generateActionsByCategory(
    const IGameState& state,
    UnitID unitID,
...
std::vector<Action> AbilityActionGenerator::generatePlayerActions(
    const IGameState& state,
    PlayerID playerID,
    const AbilityRegistry& registry) {
    ...
    for (const auto* unit : units) {
        ...
        allActions.insert(
            allActions.end(),
            std::make_move_iterator(unitActions.begin()),
