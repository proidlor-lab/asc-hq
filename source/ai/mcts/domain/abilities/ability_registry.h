...
public:
     ...
     */
    [[nodiscard]] std::vector<IAbility*> getAbilitiesForUnitType(
     ...
     * @return Vector of ability pointers (non-owning)
     */
    [[nodiscard]] std::vector<IAbility*> getAbilitiesForUnit(
     ...
     */
    [[nodiscard]] std::vector<IAbility*> getAbilitiesByCategory(
...
public:
     ...
     */
    [[nodiscard]] static std::vector<Action> generateAllActions(
     ...
     * @return Vector of all possible actions
     */
    [[nodiscard]] static std::vector<Action> generateAllActionsWithContext(
        const IGameState& state,
        UnitID unitID,
        GameMap* legacyMap,
        const AbilityRegistry& registry = AbilityRegistry::instance());
     ...
     */
    [[nodiscard]] static std::vector<Action> generateActionsByCategory(
        const IGameState& state,
        UnitID unitID,
     ...
     */
    [[nodiscard]] static std::vector<Action> generatePlayerActions(
        const IGameState& state,
        PlayerID playerID,
        const AbilityRegistry& registry = AbilityRegistry::instance());
};
