...
const char* actionCategoryToString(ActionCategory category) noexcept {
   switch (category) {
      ...
      case ActionCategory::Build:
         return "Build";
      case ActionCategory::Cargo:
         return "Cargo";
      case ActionCategory::Special:
         return "Special";
      case ActionCategory::Meta:
         return "Meta";
      default:
         return "Unknown";
   }
...
std::vector<ActionCategory> getUnitActionCategories(const UnitSnapshot& unit,
