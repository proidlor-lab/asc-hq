...
class ILegacyGameInterface {
  public:
    ...
    */
   virtual bool executeMove(UnitID unitID, ::MapCoordinate destination,
    ...
    */
   virtual bool executeAttack(UnitID attackerID, UnitID targetID,
                              MapDisplayInterface* display = nullptr) = 0;
...
class LegacyGameInterface : public ILegacyGameInterface {
  public:
   ...
   bool executeMove(UnitID unitID, ::MapCoordinate destination,
                    MapDisplayInterface* display = nullptr) override;

   bool executeAttack(UnitID attackerID, UnitID targetID,
                      MapDisplayInterface* display = nullptr) override;
