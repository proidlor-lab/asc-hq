...
Vehicle* PathfindingAdapter::createTempVehicle(
    const UnitSnapshot& unit,
    GameMap* map) const {
...
void PathfindingAdapter::syncNearbyUnits(
    const IGameState& state,
...
std::vector<ReachablePosition> PathfindingAdapter::extractReachablePositions(
    AStar3D& pathfinder) const {
