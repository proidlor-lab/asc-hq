...
BaseAI* AIFactory::createAI(AIType type, GameMap* gameMap, int playerID, const AIConfig& config)
{
    ...
    switch (type) {
        case AI_CLASSIC:
            ...
            displayLogMessage(1, "AIFactory: Creating Classic AI for player " + ASCString::toString(playerID) + "\n");
            return new AI(gameMap, playerID);
            
        case AI_MCTS_BALANCED:
            displayLogMessage(1, "AIFactory: Creating MCTS Balanced AI for player " + ASCString::toString(playerID) + "\n");
            return MCTS_AI::createBalanced(gameMap, playerID, config);
            
        case AI_MCTS_AGGRESSIVE:
            displayLogMessage(1, "AIFactory: Creating MCTS Aggressive AI for player " + ASCString::toString(playerID) + "\n");
            return MCTS_AI::createAggressive(gameMap, playerID, config);
            
        case AI_MCTS_DEFENSIVE:
            displayLogMessage(1, "AIFactory: Creating MCTS Defensive AI for player " + ASCString::toString(playerID) + "\n");
            return MCTS_AI::createDefensive(gameMap, playerID, config);
            
        case AI_MCTS_FAST:
            displayLogMessage(1, "AIFactory: Creating MCTS Fast AI for player " + ASCString::toString(playerID) + "\n");
            return MCTS_AI::createFast(gameMap, playerID, config);
            
        case AI_MCTS_DEEP:
            displayLogMessage(1, "AIFactory: Creating MCTS Deep AI for player " + ASCString::toString(playerID) + "\n");
...
{
    switch (type) {
        case AI_CLASSIC:         return "Classic AI";
        case AI_MCTS_BALANCED:   return "MCTS Balanced";
        case AI_MCTS_AGGRESSIVE: return "MCTS Aggressive";
        case AI_MCTS_DEFENSIVE:  return "MCTS Defensive";
        case AI_MCTS_FAST:       return "MCTS Fast";
        case AI_MCTS_DEEP:       return "MCTS Deep";
...
{
    switch (type) {
        case AI_CLASSIC:         return "classic";
        case AI_MCTS_BALANCED:   return "mcts_balanced";
        case AI_MCTS_AGGRESSIVE: return "mcts_aggressive";
        case AI_MCTS_DEFENSIVE:  return "mcts_defensive";
        case AI_MCTS_FAST:       return "mcts_fast";
        case AI_MCTS_DEEP:       return "mcts_deep";
