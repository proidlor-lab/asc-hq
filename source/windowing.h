...
class ASCGUI_Window : public PG_Window {
  ...
  public:
   ...
   void setWidgetTransparency(const ASCString& widgetName, int transparency,
                              PG_Widget* parent = NULL);

   int RunModal();

  protected:
   virtual void userHandler(const ASCString& label, PropertyReadingContainer& pc, PG_Widget* parent,
   ...
   ASCGUI_Window(PG_Widget* parent, const PG_Rect& r, const ASCString& panelName_,
                 const ASCString& baseStyle = "Panel", bool loadTheme = true);
...
class LayoutablePanel : public Panel {
  ...
  public:
   LayoutablePanel(PG_Widget* parent, const PG_Rect& r, const ASCString& panelName_,
                   bool loadTheme = true);
};
...
class ConfigurableWindow : public ASCGUI_Window {
  ...
  public:
   ConfigurableWindow(PG_Widget* parent, const PG_Rect& r, const ASCString& panelName_,
                      bool loadTheme = true);
};
