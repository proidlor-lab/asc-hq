...
class WeatherPanel : public Panel {
  public:
   WeatherPanel(PG_Widget* parent, const PG_Rect& r, const ASCString& panelName_,
                bool loadTheme = true);
  ...
  private:
   ...
   void showTurn();
   WindAccu updateWindAccu(const WindAccu&, unsigned int windspeed, Direction windDirection,
                           float ratio);
};
