  ...
  public:
   ...
   class ProductionEntry {
     public:
      ...
      ProductionEntry(const VehicleType* type, const Resources& cost,
                      ConstructUnitCommand::Lack prerequisites) {
         this->type = type;
         this->cost = cost;
   ...
   /**
      \param internally: true for internal production (inside cargo bay), false for outside
      production(neighbouring field) \return a collection of potentially producable units. Maybe
      some prerequisites are lacking, which is indicated by the Lack attribute
   */
