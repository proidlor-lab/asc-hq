...
ChangeContainerProperty::ChangeContainerProperty(ContainerBase* container, Property property,
                                                 int value, bool valueIsAbsolute)
...
int ChangeContainerProperty::getUnitProperty() {
   switch (property) {
      case Damage:
         return getContainer()->damage;
      case RepairedThisTurn:
         return getContainer()->repairedThisTurn;
      default:
