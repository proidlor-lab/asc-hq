...
ChangeUnitProperty::ChangeUnitProperty(Vehicle* vehicle, Property property, int value,
...
ASCString ChangeUnitProperty::getPropertyName(Property property) {
   switch (property) {
      case ExperienceOffensive:
         return "Offensive Experience";
      case ExperienceOffensive_Raw:
         return "Offensive Experience (RAW)";
      case ExperienceDefensive:
         return "Defensive Experience";
      case ExperienceDefensive_Raw:
         return "Defensive Experience (RAW)";
      case Movement:
         return "Movement";
      case AttackedFlag:
         return "AttackedFlag";
...
int ChangeUnitProperty::getUnitProperty() {
   switch (property) {
      case ExperienceOffensive:
         return getUnit()->getExperience_offensive();
      case ExperienceDefensive:
         return getUnit()->getExperience_defensive();
      case ExperienceOffensive_Raw:
         return getUnit()->getExperience_offensive_raw();
      case ExperienceDefensive_Raw:
         return getUnit()->getExperience_defensive_raw();
      case Movement:
         return getUnit()->getMovement(false, false);
      case AttackedFlag:
         return getUnit()->attacked;
      case Height:
         return getUnit()->height;
      case Direction:
         return getUnit()->direction;
      case ReactionFire:
         return getUnit()->reactionfire.status;
      case PowerGeneration:
         return getUnit()->getGeneratorStatus();
   };
