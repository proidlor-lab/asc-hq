...
UnitAction::UnitAction(Vehicle* unit) : GameAction(unit->getMap()) {
   vehicleID = unit->networkid;
}

UnitAction::UnitAction(GameMap* gamemap) : GameAction(gamemap) {
   vehicleID = -1;
}

UnitAction::UnitAction(GameMap* gamemap, int vehicleID) : GameAction(gamemap) {
