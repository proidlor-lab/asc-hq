...
class ChangeUnitMovement : public UnitAction {
  public:
   enum Recursivity {
      NONE,    //!< only the unit itself gets its movement changed
      NORMAL,  //!< the loaded units get their movement changed too, by the normal fraction (loaded
               //!< units less than carrier)
