...
#ifndef RepairUnitCommandH
#define RepairUnitCommandH
...
class RepairUnitCommand : public ContainerCommand {
   int targetNWid;
  ...
  private:
   RepairUnitCommand(GameMap* map) : ContainerCommand(map), targetNWid(0){};
   template <class Child>
   friend GameAction* GameActionCreator(GameMap* map);

   vector<Vehicle*> externalTargets;
   vector<Vehicle*> internalTargets;
