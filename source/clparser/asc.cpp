...
Cmdline::Cmdline(int argc, char* argv[]) {
   ...
   static struct option long_options[] = {{"xresolution", 1, 0, 'x'}, {"yresolution", 1, 0, 'y'},
                                          {"load", 1, 0, 'l'},        {"mapfile", 1, 0, 'M'},
                                          {"configfile", 1, 0, 'c'},  {"verbose", 1, 0, 'r'},
                                          {"window", 0, 0, 'w'},      {"fullscreen", 0, 0, 'f'},
                                          {"nosound", 0, 0, 'q'},     {"help", 0, 0, 'h'},
                                          {"version", 0, 0, 'v'},     {"headless", 0, 0, 'H'},
                                          {"player1", 1, 0, 'P'},     {"player2", 1, 0, 'Q'},
                                          {"turnlimit", 1, 0, 'T'},   {0, 0, 0, 0}};
   ...
   while ((c = getopt_long(argc, argv, "x:y:l:c:r:wfqhvHM:P:Q:T:", long_options, &option_index)) !=
          EOF) {
      switch (c) {
         case 'x':
            _x = atoi(optarg);
...
void Cmdline::usage() {
   ...
   cout << "         Options: classic, mcts_balanced, mcts_aggressive, mcts_defensive, mcts_fast, "
           "mcts_deep\n";
   cout << "  [ -Q ] ";
   cout << "[ --player2 ]  ";
   cout << "(";
