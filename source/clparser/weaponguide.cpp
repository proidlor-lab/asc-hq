...
Cmdline::Cmdline(int argc, char* argv[]) {
   ...
   static struct option long_options[] = {{"configfile", 1, 0, 'c'},   {"verbose", 1, 0, 'r'},
                                          {"directory", 1, 0, 'd'},    {"linkdir", 1, 0, 'l'},
                                          {"set", 1, 0, 's'},          {"image", 0, 0, 'i'},
                                          {"imgsize", 1, 0, 'z'},      {"framename", 1, 0, 'f'},
                                          {"style", 1, 0, 't'},        {"menustyle", 1, 0, 'm'},
                                          {"allbuildings", 0, 0, 'b'}, {"roottech", 1, 0, 256},
                                          {"writeall", 0, 0, 257},     {"help", 0, 0, 'h'},
   ...
   while ((c = getopt_long(argc, argv, "c:r:d:l:s:iz:f:t:m:bhv", long_options, &option_index)) !=
          EOF) {
      switch (c) {
         case 'c':
            _c = optarg;
...
void Cmdline::usage() {
   ...
   cout << "FLAG";
   cout << ")\n";
   cout << "         skip the check for changed files, which speeds up operation, but touches all "
           "files\n";
   cout << "  [ -h ] ";
   cout << "[ --help ]  ";
   cout << "(";
