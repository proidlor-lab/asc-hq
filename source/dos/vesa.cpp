...
char getgeneralparameters(void) {
   ///////////////////////////
...
pavailablemodes searchformode(int x, int y, int col) {
   pavailablemodes avm;
   word* pw;
      ...
      while (*pw != 0xffff) {
         if (getvesamodeavail(*pw)) {
            if (((lastmodecheckgeneralparams.resolutionx == x) || (x == 0)) &&
                ...
                ((lastmodecheckgeneralparams.memorymodel == 6) ||
                 (lastmodecheckgeneralparams.memorymodel ==
                  4))) { /* direct color || packed pixel */
...
char getvesamodeavail(int modenum) {
   ...
   memcpy(&lastmodecheckvesaparams, (void*) (vesainfosegment * 0x10),
          sizeof(lastmodecheckvesaparams));
   ...
   if ((lastmodecheckvesaparams.modeattributes & 128) && !dont_use_linear_framebuffer) {
      ...
      if ((lastmodecheckvesaparams.winaattributes & 7) != 7) {
         if ((((lastmodecheckvesaparams.winaattributes & 7) == 3) &&
              ((lastmodecheckvesaparams.winbattributes & 7) == 5)) ||
             (((lastmodecheckvesaparams.winaattributes & 7) == 5) &&
              ((lastmodecheckvesaparams.winbattributes & 7) == 3))) {
   ...
   if (vesainfo.capabilities & 128) {} /* endif */
   /*
  freigeben des speichers f Å r interruptaufruf */
   ...
   lastmodecheckgeneralparams.granularity =
      (char) (6 - loga2(lastmodecheckvesaparams.wingranularity));
   ...
   if (getvesamodeavail(modenum & 0x3fff)) {
      ...
      *agmp = lastmodecheckgeneralparams;
      ...
      if (regs.w.dx < agmp->resolutiony || regs.w.bx < agmp->resolutionx) {
         if (vesaerrorrecovery == 0) {
            settextmode(3);
            printf(
               " The VESA-bios returned invalid parameters ! This is a bug in your graphic hard- "
      ...
      *hgmp = *agmp;
      ...
      if (lastmodecheckgeneralparams.windowstatus == 100) {
         ...
         regs.w.cx =
            (short) (lastmodecheckvesaparams.linearframebuffer & 0xffff); /* bx:cx = address */
