...
static void __interrupt __far keyboard() {
   ...
   if (key > 0) {
      ...
      ekey = key;
      if ((skeypress(42) || skeypress(54)) && (key != 42) && (key != 54))
         ekey = key + 256; /* Shift */
      if ((skeypress(29) || skeypress(129)) && (key != 29) && (key != 129))
         ekey = key + 512; /* Strg */
      if ((skeypress(56) || skeypress(156)) && (key != 56) && (key != 156))
         ekey = key + 1024; /* Alt */
      if (exkey > 0) {
         exkey = 0;
         if (key <= 83) {
