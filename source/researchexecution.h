...
//! dissects a vehicle; if you haven't researched this vehicle type you will get some research
//! points for it.
extern void dissectvehicle(Vehicle* eht);

/** progresses in the current research, automatically chosing technologies towards the research
   goal.
...
*/
extern void runResearch(Player& player, vector<const Technology*>* newTechs,
