...
class FieldAddressing : protected PolygonPainterSquareCoordinate {
  ...
  protected:
   ...
   void setup();
   friend Event* readOldEvent(tnstream* stream, GameMap* gamemap, map<int, int>& eventTranslation,
...
class BuildingConquered : public BuildingPositionTrigger, public sigc::trackable {
  ...
  public:
   ...
   BuildingConquered(const MapCoordinate& position)
      : BuildingPositionTrigger(Trigger_BuildingConquered) {
      pos = position;
   };
...
class BuildingDestroyed : public BuildingPositionTrigger {
  ...
  public:
   ...
   BuildingDestroyed(const MapCoordinate& position)
      : BuildingPositionTrigger(Trigger_BuildingDestroyed) {
      pos = position;
   };
...
class BuildingSeen : public BuildingPositionTrigger, public sigc::trackable {
  ...
  public:
   ...
   BuildingSeen(const MapCoordinate& position) : BuildingPositionTrigger(Trigger_BuildingSeen) {
      pos = position;
   };
...
class SpecificUnitEntersPolygon : public EventTrigger,
                                  public FieldAddressing,
  ...
  public:
   SpecificUnitEntersPolygon(int unitID_ = -1)
      : EventTrigger(Trigger_SpecificUnitEntersPolygon),
        FieldAddressing(gamemap),
        unitID(unitID_),
        found(false),
        arming(false){};
...
class AnyUnitEntersPolygon : public EventTrigger, public FieldAddressing, public sigc::trackable {
  ...
  public:
   AnyUnitEntersPolygon(int player_ = 0)
      : EventTrigger(Trigger_AnyUnitEntersPolygon),
        FieldAddressing(gamemap),
        player(player_),
        found(false),
        arming(false){};
...
class WindChange : public EventAction {
  ...
  public:
   WindChange() : EventAction(EventAction_WindChange), speed(0), direction(0){};

   WindChange(int Speed, int Direction)
      : EventAction(EventAction_WindChange), speed(Speed), direction(Direction){};
...
class ChangeGameParameter : public EventAction {
  ...
  public:
   ChangeGameParameter()
      : EventAction(EventAction_ChangeGameParameter), parameterNum(-1), parameterValue(0){};

   ChangeGameParameter(int ParameterNum, int ParameterValue)
      : EventAction(EventAction_ChangeGameParameter),
...
class DisplayMessage : public EventAction {
  ...
  public:
   DisplayMessage() : EventAction(EventAction_DisplayMessage), messageNum(-1){};
   DisplayMessage(int messageNumber)
      : EventAction(EventAction_DisplayMessage), messageNum(messageNumber){};
   void readData(tnstream& stream);
   void writeData(tnstream& stream);
...
class WeatherChange : public MapModificationEvent {
  ...
  public:
   WeatherChange(int weather_ = -1)
      : MapModificationEvent(EventAction_WeatherChange), weather(weather_){};
   void readData(tnstream& stream);
   void writeData(tnstream& stream);
...
class MapChange : public MapModificationEvent {
  ...
  public:
   MapChange(int terrainID_ = -1)
      : MapModificationEvent(EventAction_MapChange), terrainID(terrainID_){};
   void readData(tnstream& stream);
   void writeData(tnstream& stream);
   void setup();
...
class AddObject : public MapModificationEvent {
  ...
  public:
   AddObject() : MapModificationEvent(EventAction_AddObject), objectID(-1){};
   AddObject(int objectID_) : MapModificationEvent(EventAction_AddObject), objectID(objectID_){};
   void readData(tnstream& stream);
   void writeData(tnstream& stream);
   void setup();
...
class ChangeBuildingDamage : public EventAction {
  ...
  public:
   ChangeBuildingDamage() : EventAction(EventAction_ChangeBuildingDamage), damage(0){};
   ChangeBuildingDamage(const MapCoordinate& pos, int dam)
      : EventAction(EventAction_ChangeBuildingDamage), damage(dam), position(pos){};
...
class DisplayEllipse : public EventAction {
  ...
  public:
   DisplayEllipse()
      : EventAction(EventAction_DisplayEllipse),
        x1(-1),
        y1(-1),
        x2(-1),
        y2(-1),
...
class AddProductionCapability : public EventAction {
  ...
  public:
   AddProductionCapability()
      : EventAction(EventAction_AddProductionCapabiligy), vehicleTypeID(-1){};
...
class ChangeDiplomaticStatus : public EventAction {
  ...
  public:
   ChangeDiplomaticStatus()
      : EventAction(EventAction_ChangeDiplomaticStatus),
        proposingPlayer(0),
        targetPlayer(0),
        proposal(Peace){};
...
class SetViewSharing : public EventAction {
  ...
  public:
   SetViewSharing()
      : EventAction(EventAction_SetViewSharing),
        viewingPlayer(0),
        providingPlayer(0),
        enable(true){};
