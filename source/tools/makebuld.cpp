      ...
      if (mouseparams.taste == 1)
         for (i = 0; i < 4; i++) {
            for (j = 0; j < 6; j++) {
               ...
               if (mouseparams.x >= xp && mouseparams.x < xp + 30 && mouseparams.y >= yp &&
                   mouseparams.y < yp + 30) {
                  k = 0;
                  for (y = 0; y < 10; y++) {
                     putpixel(xp + 10 - y, yp + y, 0);
                     putpixel(xp + 20 + y, yp + y, 0);
                     if (mouseparams.x > xp + 10 - y && mouseparams.x <= xp + 20 + y &&
                         mouseparams.y == yp + y) {
                        k++;
                     }
                  } /* endfor */
                  ...
                  for (y = 10; y < 20; y++) {
                     ...
                     if (mouseparams.x >= xp && mouseparams.x <= xp + 30 &&
                         mouseparams.y == yp + y) {
                        k++;
                     }
                  } /* endfor */
   ...
   for (y = 0; y <= 5; y++)
      for (x = 0; x <= 3; x++)
         if (bilder[x][y]) {
            ...
            getimage(100 + 40 * x + (y & 1) * 20, 100 + 20 * y, 139 + 40 * x + (y & 1) * 20,
                     138 + 20 * y, bilder2[x][y]);
            mount(p1, p2, size - 4);
         } else
            bilder2[x][y] = NULL;
            ...
            for (int y = 0; y < 6; y++)
               for (int x = 0; x < 4; x++)
                  if (bld.picture[i][x][y])
                     putspriteimage(20 + 40 * x + (y & 1) * 20 + 180 * (i % 4),
                                    20 + 20 * y + 400 * (i / 4), bld.picture[i][x][y]);
