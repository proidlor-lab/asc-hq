...
int main(int argc, char* argv[]) {
   ...
   for (i = 0; i < 256; i++) {
      ...
      for (j = i + 1; j < 256; j++) {
         ...
         for (k = 0; k < 256; k++) {
            actdif = calcdiff((*activepalette256)[k][0] * 2, r, (*activepalette256)[k][1] * 2, g,
   ...
   for (int sh = 0; sh < 8; sh++) {
      ...
      for (i = 0; i < 256; i++) {
         ...
         for (k = 0; k < 256; k++) {
            actdif2 = calcdiff((*activepalette256)[k][0], r2, (*activepalette256)[k][1], g2,
   ...
   for (i = 0; i < 256; i++) {
      ...
      for (k = 0; k < 255; k++) {
         actdif2 = calcdiff(pal[k][0], r2, pal[k][1], g2, pal[k][2], b2);
         if (actdif2 < diff2) {
            diff2 = actdif2;
            bi2asc[i] = k;
         }
