...
class InfoPage {
  public:
    ...
    */
   const ASCString getPageFileName() { return fullFileName; }
  ...
  protected:
   ...
   ASCString filePath;
   /**
    *@brief The index of a concrete page category (used to distinguish between files for the same
    *subject)
    */
   ASCString index;
   /**
   ...
   /**
    *@brief The GuideGenerator who started the page construction. Holds several necessary
    *informations
    */
    ...
    *@param index The index for the page. Distinguishes it from the other pages for that
    *ContainerBaseType
    *@param title The title displayed on the page
    *@param generator The GuideGenerator which is constructing this page
    */
   InfoPage(const ContainerBaseType& contBaseType, ASCString fileName, ASCString filePath,
            ASCString index, ASCString title, GuideGenerator* generator);
    ...
    *@param interpretHAs Defines if the height is to be seen absolute, relative or none is
    *specified. Possible Values are ABSOLUTE, RELATIVE and NONE. Default is NONE
    ...
    */
   void startTable(int border, TableWidth interpretWAs = NONE, int width = 0,
                   TableWidth interpretHAs = NONE, int height = 0, TableFrame frame = VOID,
                   ASCString cssClass = "", const IntVec* cols = 0);
   /**
    ...
    */
   ASCString constructImageLink(ASCString ref, ASCString altText, ASCString cssClass = "",
                                int width = 0);
   /**
   ...
   */
    ...
    *@param data The string to be filled in the new added table data field contained in a new table
    *row
    */
...
class BuildingInfoPage : public InfoPage {
   ...
   */
    ...
    *@param generator The GuideGenerator which is constructing this page
    */
   BuildingInfoPage(const BuildingType& buildingType, ASCString filePath, ASCString index,
                    ASCString title, BuildingGuideGen* generator);
   /**
...
/**
@brief  Representation of one the building information page containing the general (and most
important)
*        informations
*@author Kevin Hirschmann
*/
...
/**
@brief  Representation of one the building information page containing information where the
building
*       can be build
*@author Kevin Hirschmann
*/
...
/**
@brief  Representation of one the building information page containing the information about which
cargo the BuildingType can contain
*@author Kevin Hirschmann
*/
...
/**
@brief  Representation of one the building information page containing the information which
resources the building can provide. Research points are treated as one resource a building can
provide
*@author Kevin Hirschmann
*/
...
class UnitInfoPage : public InfoPage {
  public:
    ...
    */
   UnitInfoPage(const VehicleType& vehicleType, ASCString filePath, ASCString index,
...
class TechTreePage : public InfoPage {
  public:
   TechTreePage(const ContainerBaseType& cbt, ASCString fileName, ASCString filePath,
                GuideGenerator* generator, ASCString techPicPath);
