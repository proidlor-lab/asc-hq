...
int main(int argc, char* argv[]) {
   ...
   try {
      ...
      fprintf(overview,
              ...
              "</HEAD>\n"
              "\n"
              "<BODY bgcolor=\"#447744\" text=\"#eabc1a\" link=\"#EABC1A\" vlink=\"#EABC1A\" "
              "alink=\"#EABC1A\" background=\"../ug-hin.gif\" leftmargin=\"5\" topmargin=\"2\">\n"
              "<table width=\"100%\" border=\"1\" bordercolordark=\"#333333\" "
              "bordercolorlight=\"#408050\" cellpadding=\"1\" cellspacing=\"1\">\n"
      ...
      fprintf(overview1,
              ...
              "\n"
              "<BODY bgcolor=\"#447744\" text=\"#eabc1a\" link=\"#EABC1A\" vlink=\"#EABC1A\" "
              "alink=\"#EABC1A\" background=\"../ug-hin.gif\" leftmargin=\"5\" topmargin=\"0\">\n");
      ...
      for (int unit = 0; unit < vehicletypenum; unit++) {
         ...
         if (patimat(wildcard, ft->filename.c_str())) {
            ...
            fprintf(detailed,
                    ...
                    "<noframes><body><p>Diese Seite verwendet Frames. Frames werden von Ihrem "
                    "Browser aber nicht unterst�tzt.</p></body></noframes>\n"
                    "</frameset>\n"
                    "</html>\n",
                    s1.c_str(), s6.c_str());
            ...
            fprintf(detailed1,
                    ...
                    "\n"
                    "<BODY bgcolor=\"#447744\" text=\"#eabc1a\" link=\"#EABC1A\" vlink=\"#EABC1A\" "
                    "alink=\"#EABC1A\" background=\"../ug-hin.gif\">\n");
            ...
            // OVERVIEW RIGHT
            fprintf(overview1,
                    "<table align=\"center\" border=\"1\" bordercolordark=\"#333333\" "
                    "bordercolorlight=\"#408050\" cellpadding=\"1\" cellspacing=\"1\">\n"
                    " <tr><td rowspan=\"2\" width=\"50\">");
            if (exist(b1.c_str()))
               fprintf(overview1, "<img src=\"%s\" border=\"0\">", b1.c_str());
            fprintf(overview1,
                    "</td><td width=\"140\"><A HREF=\"%s\">%s</A></td></tr><tr><td><a "
                    "href=\"%s\">%s</a></td></tr></table>\n",
                    s.c_str(), ft->name.c_str(), s.c_str(), ft->description.c_str());

            // END OVERVIEW RIGHT

            // we are adding a link to the overview file.
            // to put a singile " into a string we must use double quotes ( "" ), because a single
            // quote is interpreted as the end of the string by C %s tells C to insert a string
            // there. The strings are appended at the end of the command at the first %s the
            // filename in s is inserted, at the second %s the unit variable 'description'

            // UNIT GENERAL
            fprintf(
               detailed1,
               "<table width=\"100%\" id=\"H2\" border=\"1\" bordercolordark=\"#333333\" "
               "bordercolorlight=\"#408050\" cellpadding=\"1\" cellspacing=\"1\"> \n"
            ...
            fprintf(detailed1,
                    "<table id=\"H2\" border=\"1\" bordercolordark=\"#333333\" "
                    "bordercolorlight=\"#408050\" cellpadding=\"1\" cellspacing=\"1\"> \n");
            fprintf(detailed1,
                    "<tr><td bgcolor=\"#20483f\">Name</td>         <td align=\"center\" "
                    "colspan=\"4\">%s</td> </tr>\n",
                    ft->name.c_str());
            if (!ft->description.empty())
               fprintf(detailed1,
                       "<tr><td bgcolor=\"#20483f\">Description</td>  <td align=\"center\" "
                       "colspan=\"4\">%s</td> </tr>\n",
               ...
               fprintf(detailed1,
                       ...
                       "colspan=\"4\">--</td> </tr>\n");
            fprintf(detailed1,
                    "<tr><td bgcolor=\"#20483f\">ID</td>           <td align=\"center\">%i</td> "
                    "<td></td><td bgcolor=\"#20483f\">Weight</td> <td align=\"center\">%d</td> <td "
                    "bgcolor=\"#20483f\">Type</td><td>%s</td> </tr>\n",
                    ft->id, ft->weight, cmovemalitypes[ft->movemalustyp]);
            fprintf(
               detailed1,
               "<tr><td bgcolor=\"#20483f\">Armor</td>        <td align=\"center\">%i</td> "
               "<td></td><td bgcolor=\"#20483f\">View</td>   <td align=\"center\">%d</td> </tr>\n",
               ft->armor, (ft->view / 10));
            fprintf(
               detailed1,
               "<tr><td bgcolor=\"#20483f\">Cost energy</td>  <td align=\"center\">%i</td> "
               "<td></td><td bgcolor=\"#20483f\">Jamming</td><td align=\"center\">%d</td> </tr>\n",
               ft->productionCost.material, (ft->jamming / 10));
            fprintf(
               detailed1,
               "<tr><td bgcolor=\"#20483f\">Cost material</td><td align=\"center\">%i</td> </tr>\n",
               ft->productionCost.energy);

            if (ft->wait)
               fprintf(detailed1,
                       "<tr><td bgcolor=\"#20483f\" colspan=\"4\">Attack after move</td> "
                       "<td>No</td> </tr>\n");
            else
               fprintf(detailed1,
                       "<tr><td bgcolor=\"#20483f\" colspan=\"4\">Attack after move</td> "
            ...
            if (ft->functions & cf_moveafterattack)
               fprintf(detailed1,
                       "<tr><td bgcolor=\"#20483f\" colspan=\"4\">Move after Attack</td> "
                       "<td>Yes</td></tr>\n");
            else
               fprintf(detailed1,
                       "<tr><td bgcolor=\"#20483f\" colspan=\"4\">Move after Attack</td> "
            ...
            // take a look at the vehicletype class in vehicletype.h for the names of all variables
            // that make a vehicletype be carefuel not to make a , at the end of the first lines,
            // since this would seperate the string in to several independant strings
            ...
            // Tabellenbeginn
            fprintf(detailed2,
                    "<TABLE align=\"left\" rules=\"rows\" id=\"H9\" border=\"1\" "
                    "bordercolordark=\"#333333\" bordercolorlight=\"#408050\" cellpadding=\"1\" "
                    "cellspacing=\"1\">"
                    "<TR><td colspan=\"9\" bgcolor=\"#20483f\" id=\"H2\">Reachable levels of "
                    "height:</td></tr>\n<tr>");
            // Spaltentitel
            ...
            /* ????
                     ...
                     for ( i = 0; i < 8; i++ )
                        if ( (ft->height & ( 1 << i )) && ft->fuelConsumption )
                           fprintf ( detailed2, " <TD align=\"center\">%d</TD>",
               ft->tank.fuel/ft->fuelConsumption ); else fprintf ( detailed2, " <TD></TD>"  );
            */
            fprintf(detailed2, "\n</TR>\n</TABLE>\n");
            ...
            if (ft->fuelConsumption > 0)
               fprintf(detailed2,
                       "<tr><td bgcolor=\"#20483f\">Max.Movem.</td>   <TD "
                       "align=\"center\">%d</TD></tr>\n",
            ...
            // Bodentypen global
            fprintf(detailed2,
                    "<br><br>\n<table rules=\"rows\" id=\"H2\" border=\"1\" "
                    "bordercolordark=\"#333333\" bordercolorlight=\"#408050\" cellpadding=\"1\" "
                    "cellspacing=\"1\"><tr><td colspan=\"34\" bgcolor=\"#20483f\">");
            fprintf(detailed2, "Terraintypes for not flying units:</td></tr>\n<tr>");

            // Spalten gfx
            fprintf(detailed2, "<td></td>");
            for (int i = 0; i < cbodenartennum; i++)
               fprintf(detailed2, " <TD><IMG src=\"../gfx%d.gif\" alt=\"%s\"></TD>", i,
                       cbodenarten[i]);
            fprintf(detailed2, "</TR>\n<TR>\n");
            ...
            fprintf(detailed3,
                    "<table id=\"H10\" border=\"1\" bordercolordark=\"#333333\" "
                    "bordercolorlight=\"#408050\" cellpadding=\"1\" cellspacing=\"1\"> \n");
            // �berschriften
            fprintf(
               detailed3,
            ...
            for (w = 0; w < ft->weapons.count; w++) {
               ...
               fprintf(detailed3, "    <td align=\"center\">%d</td>",
                       (ft->weapons.weapon[w].mindistance + 9) / 10);
               fprintf(detailed3, "    <td align=\"center\">%d</td>",
                       ft->weapons.weapon[w].maxstrength);
               fprintf(detailed3, "    <td align=\"center\">%d</td>",
                       (ft->weapons.weapon[w].maxdistance) / 10);
               fprintf(detailed3, "    <td align=\"center\">%d</td>",
                       ft->weapons.weapon[w].minstrength);
               // H�henstufenzeichen einf�gen f�r shoot from und target
               for (i = 0; i < 8; i++)
            ...
            // Aber die minimale Entfernung mu� aufgerundet werden, deshalb benutze ich einen
            // kleinen Trick: Ich addiere vor der Division 9 (also Quotient-1) dazu

            // Weapon can hit:
            fprintf(detailed3,
                    "<table id=\"H9\" border=\"1\" bordercolordark=\"#333333\" "
                    "bordercolorlight=\"#408050\" cellpadding=\"1\" cellspacing=\"1\"> \n");
            // Ueberschrift
            fprintf(detailed3,
                    "<tr><td></td><td align=\"center\" colspan=\"17\" bgcolor=\"#20483f\">The "
                    "weapon can hit: </td></tr>");
            // Spalten GFX
            ...
            // Ueberschrift
            fprintf(detailed3,
                    "<tr><td></td><td align=\"center\" colspan=\"14\" bgcolor=\"#20483f\" "
                    ">Efficiency over high difference: </td></tr>\n");
            ...
            // BEGINN FUNCTIONS
            fprintf(detailed4,
                    "<table align=\"left\" id=\"H10\" border=\"1\" bordercolordark=\"#333333\" "
                    "bordercolorlight=\"#408050\" cellpadding=\"1\" cellspacing=\"1\">");
            // Ueberschrift
            fprintf(
               detailed4,
               "<tr><td align=\"center\" bgcolor=\"#20483f\">Special Unit functions</td></tr>");
            ...
            if (ft->maxwindspeedonwater)
               fprintf(detailed4,
                       "<tr><td align=\"center\" bgcolor=\"#20483f\">Max. windspeed on water</td> "
                       "<td>%d</td> </tr>",
                       ft->maxwindspeedonwater);
            else
               fprintf(detailed4,
                       "<tr><td align=\"center\" bgcolor=\"#20483f\">Max. windspeed on water</td> "
                       "<td>--</td> </tr>");
            fprintf(detailed4,
                    "<tr><td align=\"center\" bgcolor=\"#20483f\">Ressource search "
                    "range</td><td>%d</td> </tr>",
                    ft->digrange);
            fprintf(detailed4,
                    "<tr><td align=\"center\" bgcolor=\"#20483f\">Auto repair rate</td> "
                    "<td>%d</td> </tr>",
                    ft->autorepairrate);
            //         fprintf ( detailed4, "<tr><td align=\"center\" bgcolor=\"#20483f\">Max. unit
            //         weight</td><td>%d</td> </tr>/n", ft->maxunitweight );
            fprintf(detailed4, "</table>\n");

            // Objekte
            fprintf(detailed4,
                    "<table align=\"left\" id=\"H9\" border=\"1\" bordercolordark=\"#333333\" "
                    "bordercolorlight=\"#408050\" cellpadding=\"1\" cellspacing=\"1\">\n");
            // Ueberschrift baubare Objekte
            fprintf(detailed4,
                    "<tr><td align=\"center\" bgcolor=\"#20483f\" colspan=\"2\">baubare "
                    "OBJEKTE</td></tr>\n");
            for (unsigned int i = 0; i < ft->objectsBuildable.size(); i++) {
               //               fprintf( detailed4, "<tr><td>es k�nnen die Objekte mit ids von %d
               //               bis %d gebaut werden</td></tr>\n", ft->objectsBuildable[i].from,
               //               ft->objectsBuildable[i].to );
            ...
            for (unsigned int i = 0; i < ft->vehiclesBuildable.size(); i++) {
               //               fprintf( detailed4, "<tr><td colspan=\"2\">baubar ID %d bis %d
               //               </td></tr>\n", ft->vehiclesBuildable[i].from,
               //               ft->vehiclesBuildable[i].to );
            ...
            if (ft->loadcapacity) {
               fprintf(detailed5,
                       ...
                       "bordercolorlight=\"#408050\" cellpadding=\"1\" cellspacing=\"1\"> ");
               fprintf(detailed5,
                       "<tr><td align=\"center\" bgcolor=\"#20483f\">Einladbare UNITS</td></tr>");

               for (int c = 0; c < cmovemalitypenum; c++)
                  if (ft->vehicleCategoriesLoadable & (1 << c))
                     fprintf(detailed5, "<tr><td align=\"center\" > %s </td></tr>",
                             cmovemalitypes[c]);
               ...
               fprintf(detailed5,
                       ...
                       "bordercolorlight=\"#408050\" cellpadding=\"1\" cellspacing=\"1\">");
               fprintf(detailed5,
                       "<tr><td align=\"center\" bgcolor=\"#20483f\">max. Zuladung</td> "
                       "<td>%d</td> </tr>",
                       ft->loadcapacity);
               fprintf(detailed5,
                       "<tr><td align=\"center\" bgcolor=\"#20483f\">max. Gewicht einer "
                       "Einheit</td><td>%d</td> </tr>",
                       ft->maxunitweight);
               fprintf(detailed5, "</table>");
               ...
               // �berschriften
               fprintf(detailed5,
                       "    <td bgcolor=\"#20483f\" colspan=\"9\" align=\"center\"> "
                       "Voraussetzungen f&uuml;r das Ein- und Ausladen </td>"
                       "</tr>\n");
               // GFX
               ...
               fprintf(detailed5,
                       ...
                       "bordercolorlight=\"#408050\" cellpadding=\"1\" cellspacing=\"1\">");
               fprintf(detailed5,
                       "<tr><td align=\"center\" bgcolor=\"#20483f\">Loadable units</td></tr>");
            ...
            fprintf(detailed6,
                    ...
                    "bordercolorlight=\"#408050\" cellpadding=\"1\" cellspacing=\"1\">");
            fprintf(detailed6,
                    "<tr><td align=\"center\" bgcolor=\"#20483f\">Unit description</td></tr>");
            ...
            /*           // NEU - noch anzupassen
               ...
               ft->buildingsBuildable[i].from, ft->buildingsBuildable[i].to ); for ( int b = 0; b <
               buildingtypenum; b++ ) { BuildingType* bld = getbuildingtype_forpos ( b ); if (
               bld->id >= ft->buildingsBuildable[i].from
                                       && bld->id <= ft->buildingsBuildable[i].to ) {
                                 printf( "das geb�ude mit id %d und dem Namen %s kann gebaut
               werden\n", bld->id, bld->name.c_str() );
                              }
                           }
                        }
            */
            /*            for ( int i = 0; i  < ft->vehiclesBuildable.size(); i++ ) {
               ...
               ft->vehiclesBuildable[i].from, ft->vehiclesBuildable[i].to ); for ( int b = 0; b <
               vehicletypenum; b++ ) { Vehicletype* veh = getvehicletype_forpos ( b ); if ( veh->id
               >= ft->vehiclesBuildable[i].from
                                    && veh->id <= ft->vehiclesBuildable[i].to ) {
                                 printf( "die einheit mit id %d und dem Namen %s kann gebaut
               werden\n", veh->id, veh->getName().c_str() );
                              }
                           }
                        }
            */
            /*            for ( int i = 0; i < ft->objectsBuildable.size(); i++ ) {
               ...
               ft->objectsBuildable[i].from, ft->objectsBuildable[i].to ); for ( int b = 0; b <
               objecttypenum; b++ ) { Object*type obj = getobjecttype_forpos ( b ); if (     obj->id
               >= ft->objectsBuildable[i].from
                                    && obj->id <= ft->objectsBuildable[i].to ) {
                                 printf( "die einheit mit id %d und dem Namen %s kann gebaut
               werden\n", obj->id, obj->name.c_str() );
