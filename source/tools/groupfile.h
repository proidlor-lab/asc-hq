...
class AbstractEntry {
  ...
  public:
   ...
   /**
    *@brief Defines an order upon AbstractEntry. The order is equivalent to the alphabetic order of
    *member lineData
    */
  ...
  protected:
   ...
   AbstractEntry(ASCString data, ASCString css)
      : cssFile(css), lineData(data), parent(0), depth(0){};
};
